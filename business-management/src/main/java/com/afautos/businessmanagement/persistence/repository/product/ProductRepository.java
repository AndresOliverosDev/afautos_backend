...
public interface ProductRepository extends JpaRepository<ProductEntity, Long>{
    ...
    @Query("SELECT new com.afautos.businessmanagement.presentation.dto.product.ProductDTO(p.id, p.name, p.desc, p.quantity, p.price, p.image, p.category.name, p.brand.name) FROM ProductEntity p")
